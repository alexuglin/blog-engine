...
import com.skillbox.diplom.service.SettingsService;
...
public class ApiGeneralController {
    ...
    public ResponseEntity<StatisticsBlog> getMyStatistics() {
        return infoService.getMyStatistics();
    }

    @GetMapping("/statistics/all")
    public ResponseEntity<StatisticsBlog> getStatistics() {
        return infoService.getStatistics();
    }

    @PutMapping("/settings")
    public ResponseEntity<ErrorResponse> editSettings(@RequestBody Map<NameSetting, Boolean> settings) {
